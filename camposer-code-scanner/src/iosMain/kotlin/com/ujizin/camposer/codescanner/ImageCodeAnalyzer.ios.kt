...
internal actual class ImageCodeAnalyzer(
  ...
  internal val delegate: AVCaptureMetadataOutputObjectsDelegateProtocol =
    object : NSObject(), AVCaptureMetadataOutputObjectsDelegateProtocol {
      ...
      private fun AVMetadataMachineReadableCodeObject.getCornerPointers(): List<CornerPointer> =
        corners
      ...
      private fun AVMetadataMachineReadableCodeObject.getFrameRect(): FrameRect =
        memScoped {
          val boundsRef =
            previewLayer
