package com.ujizin.camposer.internal.error

import platform.Foundation.NSError

internal open class NSErrorException(
  nsError: NSError,
) : Exception(nsError.localizedDescription)

internal open class CameraException(
  message: String,
) : Exception("Camera exception: $message")
...
internal class ErrorRecordVideoException(
  nsError: NSError,
) : CameraNSErrorException(
    message = "Error recording video",
    nsError = nsError,
  )

internal class ErrorTakePhotoException(
  nsError: NSError,
) : CameraNSErrorException(
...
internal class ErrorWritePhotoPathException(
  filename: String,
) : CameraException(
