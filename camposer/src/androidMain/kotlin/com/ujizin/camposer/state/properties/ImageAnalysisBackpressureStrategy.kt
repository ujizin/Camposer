 ...
 * */
public enum class ImageAnalysisBackpressureStrategy(
  ...
  /**
   *  add multiple images to the internal image queue and begin dropping frames only
   *  when the queue is full, used for blocking operation.
   * */
