...
public actual enum class CodeType(internal val rawType: String?) {
    ...
    DataBarGS1(AVMetadataObjectTypeGS1DataBarCode),
    DataBarGS1Limited(AVMetadataObjectTypeGS1DataBarLimitedCode),
    DataBarGS1Expanded(AVMetadataObjectTypeGS1DataBarExpandedCode),
