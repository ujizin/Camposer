...
To determine whether the device supports focus on tap functionality, use the `isFocusSupported` property from cameraSession:

```kotlin
val isFocusSupported = cameraSession.info.isFocusSupported
```
