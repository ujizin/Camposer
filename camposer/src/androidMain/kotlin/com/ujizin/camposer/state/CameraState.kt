...
public actual class CameraState(context: Context) {
     ...
     * */
    public actual var maxZoom: Float by mutableStateOf(
     ...
     * */
    public actual var minZoom: Float by mutableStateOf(
     ...
     * */
    public actual var minExposure: Int by mutableStateOf(
     ...
     * */
    public actual var maxExposure: Int by mutableStateOf(
     ...
     * */
    internal actual var isImageAnalysisEnabled: Boolean = true
        set(value) {
            if (value != field) {
