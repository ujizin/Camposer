...
private fun ConfigurationSection(
  user: User,
  onConfigurationChange: (User) -> Unit,
) {
  Column(
    modifier = Modifier
      .fillMaxSize()
    ...
    ConfigurationOption(
      ...
      onCheckedChange = {
        onConfigurationChange(user.copy(usePinchToZoom = !user.usePinchToZoom))
      },
    )
    ConfigurationOption(
      ...
      onCheckedChange = {
        onConfigurationChange(user.copy(useTapToFocus = !user.useTapToFocus))
      },
    )
  }
}
