...
internal object CameraUtils {
    ...
    private fun getMaximumFps(cameraId: String, quality: Int): Int? {
        try {
    ...
    private fun getResolutionForCamcorderProfileQuality(
        camcorderProfile: Int,
    ): Int = when (camcorderProfile) {
