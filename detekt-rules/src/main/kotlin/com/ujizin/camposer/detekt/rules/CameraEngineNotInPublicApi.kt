 ...
 */
class CameraEngineNotInPublicApi(config: Config = Config.empty) : Rule(config) {

    override val issue = Issue(
        id = javaClass.simpleName,
        severity = Severity.Defect,
        description = "CameraEngine must never be exposed through a public type. Mark the declaration internal or private.",
        debt = Debt.TEN_MINS,
    )
