...
public actual class CameraState(
  ...
  // No-op in iOS
  public actual var implementationMode: ImplementationMode by mutableStateOf(
  ...
  internal fun getCurrentVideoOrientation() =
    when (orientationStrategy) {
      OrientationStrategy.Device -> iosCameraSession.orientationListener.currentOrientation
